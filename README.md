...
<p>
We do this by running the "response.cfm" program that is discussed above.  We want to see what the CFDUMP shows us. Is there a child array? Does the main array have multiple element.. 1, 2, 3,... ?, what are the names of the structre keys we are interested in using, and what is the name of the child array, if there is one.  All good questions, the we must EXPLORE.
<p>
